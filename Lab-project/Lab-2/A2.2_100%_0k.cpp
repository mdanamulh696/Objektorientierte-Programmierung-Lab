...
int main() 
{
    ...
    while (true) 
    {
        ...
        //     // write <<"file is created"<<endl;
        //     // write<<"file is closed"<<endl;
        //     // write.close();
        ...
        // //    ifstream obj1(test.csv,ios:: in);
        // //    ofstream obj2(test2.csv,ios:: out);
        // //    char ch ;
        // //    while(!obj1.eof())
        // //    {
        // //     getline(obj1, ch);
