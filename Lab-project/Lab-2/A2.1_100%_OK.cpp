...
{
    cout << right << setw(columnWidth) <<index << ": " << left << cons->description<< endl; 
...
void printHousehold(Household* house, float pricePerKWh) 
{
    ...
    float powerConsumptionPersons = (house->numPersons * 
                                    (house->Hot_water ? annual_average_consumption_per_person_with_electric_water_heating : annualAverageConsumptionPerPerson)); 
