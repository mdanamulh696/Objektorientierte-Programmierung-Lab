...
class Household
{
 private:
    ...
    Device* devices; // Assuming you have a 'consumer' class defined
 public:
    ...
    Device* get_devices() { return devices; } // Assuming you have a 'get_consumers()' method in the consumer class
    ...
    void set_devices(Device* newDevices) { devices = newDevices; } // Assuming you have a 'set_consumers()' method in the consumer class
